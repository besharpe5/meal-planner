      ...
      <main className="flex-1 px-5 py-14">
        <div className="mx-auto w-full max-w-2xl">
          ...
          <p className="mt-4 text-base leading-relaxed text-gray-700">
            I like cooking. I care about eating well. But when I’m asked to plan meals ahead of time,
            my brain doesn’t always cooperate. Too many options. Too many decisions. Suddenly something
            small feels overwhelming.
          </p>

          <p className="mt-4 text-base leading-relaxed text-gray-700">
            So I built MealPlanned to handle that part. Not to tell you what you <span className="italic">should</span>{" "}
            eat. Not to optimize your life. Just to make food decisions lighter—so you can enjoy the parts
            that matter.
          </p>

          <div className="mt-8 rounded-xl border border-gray-200 bg-gray-50 p-5">
            <p className="text-sm font-semibold text-gray-900">MealPlanned is for people who:</p>
