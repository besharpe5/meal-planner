...
router.get("/me", auth, async (req, res) => {
  try {
    const user = await User.findById(req.user._id).select("_id name email family isPremium premiumStartedAt premiumExpiresAt premiumSource createdAt updatedAt");
    res.json(user);
  } catch (err) {
    console.error(err);
